...
@Suite class Test_wrappedInBrackets {
    @Test func empty() {
...
@Suite class Test_unwrapBrackets {
    @Test func empty() {
...
@Suite class Test_normalizeColumnType {
...
@Suite class Test_normalizeColumnDefault {
...
@Suite class Test_compareVersionNums {
